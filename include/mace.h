...
struct CalculationResult {
    ...
    std::vector<std::array<double, 3> > forces; // std::vector<real1d<3>>
    std::array<double, 6> virial; // real1d<6>
};
...
public:
    ...
    CalculationResult
    calculate(
        const std::array<std::array<double, 3>, 3> &cell, // real2d<3, 3>
        const std::array<bool, 3> &pbc, // bool1d<3>
